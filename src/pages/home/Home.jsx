...
export const Home = () => {
  ...
  return (
    <HomeWrapper ref={ref} id="home-page">
      <TextContainer>
        <Name>Armaan Shukla</Name>
        <Position>
          <div className="text first" aria-label="Full Stack Developer">
            {produceSpans("Full Stack Developer")}
          </div>
          <div className="text second" aria-label="Machine Learning Enthusiast">
            {produceSpans("ML/AI Enthusiast")}
          </div>
          {/* <div className="text third" aria-label="UI/UX Enthusiast">
