...
import dyp from "../../assets/images/nith.png";
import highschool from "../../assets/images/neugal.png";
import sos from "../../assets/images/rws.png";
          ...
          <Educations>
            <AboutItem
              ...
              data={{
                ...
                p: "B.Tech in Mathematics and Computing (2021-2025)",
                image: dyp,
              }}
            />
            <AboutItem
              color={green}
              data={{
                title: "Neugal Public School, Bhawarna",
                p: "Secondary School (2019-2021)",
                image: highschool,
              }}
            />
            <AboutItem
              color={yellow}
              data={{
                title: "Rainbow World School, Bhawarna",
                p: "High Education (2007-2019)",
                image: sos,
              }}
            />
          </Educations>
